...
class Ventilation
{
    ...
    {
        $this->autreactivites[] = $autreactivite;
    ...
    {
        $this->autreactivites->removeElement($autreactivite);
    }
     ...
     * @return \Doctrine\Common\Collections\Collection
     */
    public function getAutreactivites()
    {
        return $this->autreactivites;
    }
}
